...
6. Access website via CloudFront URL
...
## 💼 Resume Highlight
Deployed a static website on AWS using S3 and CloudFront, improving performance with CDN caching and enabling secure HTTPS delivery.
